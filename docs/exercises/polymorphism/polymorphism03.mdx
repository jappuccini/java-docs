---
title: Polymorphism03
description: ''
---

import Exercise from '@site/src/components/Exercise';

- Passe die Klasse `Rental` aus Übungsaufgabe [Polymorphism02](polymorphism02)
  anhand des abgebildeten Klassendiagramms an
- Passe die ausführbare Klasse aus Übungsaufgabe [Polymorphism02](polymorphism02)
...
<Exercise branchSuffix="polymorphism-03" />
