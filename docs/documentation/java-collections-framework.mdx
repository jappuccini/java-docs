...
Auch die erweiterte for-Schleife basiert intern auf Iteratoren. Beim Kompilieren
wird sie automatisch in eine Iterator-Schleife umgewandelt. Die ausführliche
Schreibweise ist daher gleichwertig zur Kurzschreibweise.
