...
Da es in der aktuellen Version von Mermaid einen Fehler bei der Darstellung
statischer Attribute gibt, werden diese aktuell durch das Symbol `$`
dargestellt.
...
```
  ...
  <TabItem value="abstractAndFinalClasses" label="Abstrakte und finale Klassen">
