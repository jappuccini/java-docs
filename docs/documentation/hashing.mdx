...
<Tabs>
  <TabItem value="modulo" label="Divisionsrestmethode" default>
...
:::
  ...
  <TabItem value="multiplication" label="Multiplikative Methode" default>
...
<Tabs>
  <TabItem value="closedHashing" label="Geschlossenes Hashing mit offener Adressierung" default>
...
| 4     | Milch     |
  ...
  <TabItem value="openHashing" label="Offenes Hashing mit geschlossener Adressierung">
