...
export default function ConstructorAndStatic() {
  return (
    <Slides initSlides={defaultInitSlides}>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Verschiedene Initialisierungen eines Objekts</li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>gleiche Regeln wie beim Überladen von Methoden</li>
          </ul>
        </section>
        <section>
          <pre>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>keine Unterscheidung zwischen Objekten notwendig</li>
        ...
        <section>
          ...
          <p className='fragment'>beziehen sich auf die Klasse</p>
          <ul>
            <li className='fragment'>kein Zugriff auf Objektattribute möglich</li>
        ...
        <section data-background-iframe="https://giphy.com/embed/lMVNl6XxTvXgs">
        </section>
        <section>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Mehrere Konstruktoren durch Methodenüberladung</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Zugriff auf Instanzattribute nicht möglich</li>
          </ul>
        </section>
        <section>
