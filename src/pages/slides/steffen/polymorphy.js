...
export default function Polymorphy() {
  return (
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Smartphone -&gt; Samsung Galaxy, Apple iPhone</li>
          </ul>
        </section>
        <section>
          <h2>Limitationen der Polymorphie</h2>
          <ul>
            <li className='fragment'>spezifische Klasse muss generische Klasse erweitern</li>
            <li className='fragment'>nur public Methoden/Attribute der generischen Klasse verwendbar</li>
          </ul>
        </section>
        <section>
          <h2>Demo</h2>
        ...
        <section>
          <p>Der <strong>instanceof</strong> Operator</p>
          <ul>
            <li className='fragment'>prüft, ob eine Referenzvariable eine Instanz einer bestimmten Klasse ist.</li>
          </ul>
        </section>
        <section>
          <pre>
