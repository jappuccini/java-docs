...
export default function AbstractAndFinal() {
  return (
    <Slides initSlides={defaultInitSlides}>
      ...
      <section>
        <section>
          <p>Was ist der <strong>abstract</strong> Modifier?</p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>muss erweitert werden von einer anderen Klasse</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Erzwingen von spezifischen Implementierungen</li>
          </ul>
        </section>
        <section>
          <h2>Demo</h2>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>kann nur in abstrakten Klassen definiert werden</li>
            <li className='fragment'>definiert Signatur</li>
            <li className='fragment'>muss von erbenden Klassen implementiert werden</li>
          </ul>
        </section>
        <section>
      ...
      <section>
        <section>
          <p>Was ist der <strong>final</strong> Modifier?</p>
        </section>
        <section>
          <h2>Kann angewendet werden auf</h2>
          <ul>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Klasse ist nicht zur Erweiterung gedacht</li>
          </ul>
        </section>
        <section>
          <h2>Demo</h2>
