    ...
    <Slides initSlides={defaultInitSlides}>
      ...
      <section>
        ...
        <section>
          <h2>Exceptions</h2>
          <ul>
            <li className='fragment'>sind Fehler, die zur Laufzeit auftreten</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>eine Exceptionklasse erweitert die Klasse Exception</li>
            <li className='fragment'>Methoden definieren potenziell ausgelöste Exceptions</li>
          </ul>
        </section>
        <section>
          <p>Auslösen einer Exception</p>
          <pre>
            <code className='java' data-line-numbers="1-5|3|1"  dangerouslySetInnerHTML={{ __html: 
        ...
        <section>
          ...
          <pre>
            <code className='java' data-line-numbers='3|2-4|5-7|8-10'  dangerouslySetInnerHTML={{ __html: 
