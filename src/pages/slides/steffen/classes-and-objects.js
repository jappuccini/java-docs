    ...
    <Slides initSlides={defaultInitSlides}>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>Handy<strong>s</strong></li>
            <li className='fragment'>Mensch<strong>en</strong></li>
            <li className='fragment'>Auto<strong>s</strong></li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <p>Abstraktion von <strong>gleichartigen</strong> Objekten durch:</p>
          <ul>
        ...
        <section>
          ...
          <p></p>
          <ul>
            <li className='fragment'>Instanz/Ausprägung <strong>einer</strong> Klasse</li>
          </ul>
        </section>
        <section>
          <pre>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Unterschied Referenzvariable und Variable</li>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>Access Modifier <strong>heute relevant</strong></li>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Attribute</li>
            <li className='fragment'>Methoden</li>
            <li className='fragment'>Konstruktoren (werden später behandelt)</li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <ul>
            <li className='fragment'>um Funktionalität zur Verfügung zu stellen</li>
          </ul>
        </section>
        <section>
          <h2>Wann verwendet man private?</h2>
          <ul>
            <li className='fragment'>um Modifikation von Attributen zu verhindern</li>
            <li className='fragment'>um Implementierungsdetails zu verstecken</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Schlüsselwort <strong>this</strong></li>
