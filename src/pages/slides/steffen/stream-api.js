      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li className="fragment">
              Streams können Daten nicht direkt bearbeiten
            </li>
            <li className="fragment">
              Streams verarbeiten Daten verzögert (lazy)
            </li>
        ...
        <section>
          ...
          <ul>
            ...
            <li className="fragment">Jetzt mit Streams</li>
          </ul>
        </section>
      </section>
      <section>
