  ...
  return (
    <Slides initSlides={defaultInitSlides}>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>VarArgs Parameter ist ein Array von einem Datentyp</li>
            <li className='fragment'>Argumente werden kommagetrennt definiert</li>
          </ul>
        </section>
        <section>
          <p>Implementieren einer Methode mit VarArgs</p>
          <pre>
            <code className='java' data-line-numbers="1-5|1|2-4"  dangerouslySetInnerHTML={{ __html: 
        ...
        <section>
          ...
          <pre>
            <code className='java' data-line-numbers="1-5|3-4"  dangerouslySetInnerHTML={{ __html: 
      ...
      <section>
        ...
        <section>
          <p>Wie kann man Dogs, Cats, Baby, Child und Adult in einer Liste speichern?</p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li className='fragment'>Schnittstelle zwischen Ersteller und Verwender</li>
          </ul>
        </section>
        <section>
      ...
      <section>
        ...
        <section>
          ...
          <pre className='fragment'>
            <code className='java' data-line-numbers="2|3|4" dangerouslySetInnerHTML={{ __html: 
              '// ...\n' +
