    ...
    <Slides initSlides={defaultInitSlides}>
      <section>
        <section>
          <h2>Agenda</h2>
          <ul>
            <li className="fragment">Organisatorische Änderungen</li>
            <li className="fragment">Evaluierungsergebnisse</li>
      ...
      <section>
        <section>
          <h2>Organisatorische Änderungen</h2>
        </section>
        <section>
          <h2>Informationen unter neuer URL verfügbar</h2>
          <ul>
      ...
      <section>
        <section>
          <h2>Evaluierungsergebnisse</h2>
          <ul>
            <li className="fragment">Demos hochladen</li>
            <li className="fragment">Angst Fragen zu stellen</li>
            <li className="fragment">Etwas langsameres Tempo</li>
            <li className="fragment">Gemeinsam programmieren</li>
          </ul>
        </section>
      </section>
      <section>
      ...
      <section>
        ...
        <section>
          <h2>Vererbung</h2>
          <p>
            Durch <span>Generalisierung</span> werden gemeinsame Attribute und
